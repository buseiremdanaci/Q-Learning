...
public class Board extends JFrame implements ActionListener {
    ...
    public void createGraph() {
        ...
        JFreeChart chart2 = ChartFactory.createXYBarChart("Episode via cost Step", "Episode", false, "Steps", dataset, PlotOrientation.VERTICAL, false, false, false);
        ...
        if (source == start) {
            ...
            if (giris) {
                ...
                if (startP == null || finishP == null || oyunBoard.getGrid()[startP.x][startP.y].isDuvar() || oyunBoard.getGrid()[finishP.x][finishP.y].isDuvar()) { // if leri ayırabilrisn.
                    ...
                    oyunUI.grid[startLocX][startLocY].setBackground(new Color(99, 184, 255));
                    oyunUI.grid[finishLocX][finishLocY].setBackground(new Color(0, 139, 69));
                    // ----------------------------------------------------- //
                    fileWrite();
                    // ----------------------------------------------------- //
                    ...
                    Duration interval = Duration.between(start2, end2);
            ...
            oyunBoard = new Oyun(boardx, boardy);
            oyunUI = new OyunUI(oyunBoard);
            startLoc.setText("Number");
            finishLoc.setText("Number");
            oyun.add(oyunUI);
            oyun.add(settings);
            grafik.removeAll();
            grafik.add(chartPanel);
